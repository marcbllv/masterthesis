...
After having removed the features, new random forests are trained with the same parameters. The results are presented on the table figure ....
...
\begin{figure}
	...
	\begin{table}[h!]
  		\centering
  		\begin{tabular}{ c | c }
       		\includegraphics[width=\linewidth, height=60mm]{\input{img/roc-linear-expl-lr.pdf_tex}}
    		&
       		\includegraphics[width=\linewidth, height=60mm]{\input{img/roc-linear-expl-lr.pdf_tex}}
    		\\ \hline
       		\includegraphics[width=\linewidth, height=60mm]{\input{img/roc-linear-expl-lr.pdf_tex}}
